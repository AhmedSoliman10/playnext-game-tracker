...
const FEATURE_EMAIL = "playnira.app.mail@gmail.com";
const FEATURE_MAILTO = `mailto:${FEATURE_EMAIL}?subject=${encodeURIComponent(
  "Playnira feature suggestion",
      ...
      <DropdownMenu>
        <DropdownMenuTrigger asChild>
          <Button
            ...
            aria-label="Suggest a Playnira feature"
          >
        ...
        >
          <div className="border-b px-4 py-3">
            ...
            <p className="mt-1 text-sm leading-5 text-zinc-400">
              Tell us what would make Playnira better for your game tracking.
            </p>
          </div>
